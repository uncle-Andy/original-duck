...
import util.update.helper.StockMesHelper;
...
//				+ "&startTime=&endTime="+ endTime +"&unit=1";
	...
	public void updateAllStockMesFromDate(List<String> codes, MyDate start){
		...
		for( String code : codes){
			...
			List<StockPO> temp =  getStockMes(code,start,end);
			content.addAll(temp);
		}
