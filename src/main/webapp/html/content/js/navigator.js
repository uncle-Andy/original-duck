...
$("body").prepend("<nav style='width: 100%;height: 45px;background-color: #262626'>" +
    ...
    "<li style='float:left;height: 45px;'><a href='/html/content/html/board_list.html' class='nav-link'>分布</li></a>" +
    "<li style='float:left;height: 45px;'><a href='/html/content/html/optional_stock.html' class='nav-link'>自选</li></a></li>" +
